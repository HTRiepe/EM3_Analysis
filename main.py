...
print(Phase_2)
print(Phase_3)
Phase_SUM = Phase_1.merge(Phase_2, how='outer', left_index=True, right_index=True)
Phase_SUM = Phase_SUM.merge(Phase_3, how='outer', left_index=True, right_index=True)
print(Phase_SUM)
Phase_SUM.style()
print("3/5 Done")
